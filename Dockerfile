...
RUN make -B -C vendor/github.com/GeoNet/kit/cvendor/libmseed/ && \
  make -B -C vendor/github.com/GeoNet/kit/cvendor/libslink && \
  go install -a -installsuffix cgo -ldflags "-X main.Prefix=${BUILD}/${GIT_COMMIT_SHA}" /repo/cmd/${BUILD}
